    ...
    <div style={{ position: "relative" }}>
      <div
        style={{
          width: "50%",
          backgroundImage:
            "url('https://f005.backblazeb2.com/file/Webimages-used/greendata.png')",
          height: "100vh",
      ...
      >
        <div>
          ...
          <h4 style={{ paddingLeft: 24, marginBottom: 24, fontSize: 16 }}>
            Digital Customer's Address and Contact Information
          </h4>
        </div>
        <Formik
        ...
        >
          {({ handleChange, values }) => (
            <Form style={{ paddingLeft: 24, width: "70%" }}>
              <SelectInput
                label="Digital Customer's Address Type:"
              ...
              <TextInputDashboard
                label="Digital Customer's Address:"
              ...
              <TextInputDashboard
                label="Digital Customer's Phone Number:"
              ...
              <TextInputDashboard
                label="Digital Customer's Email:"
                value={values.email}
                onChange={handleChange}
                type="email"
                id="email"
              ...
              <SelectInput
                label="Digital Customer's Primary Communication Preference:"
              ...
              <TextInputDashboard
                label="Digital Customer's Contact Person Name:"
              ...
              <TextInputDashboard
                label="Digital Customer's Contact Person Title:"
              ...
              <TextInputDashboard
                label="Digital Customer's Contact Person Email:"
...
export default DigitalCustomerStepB;
