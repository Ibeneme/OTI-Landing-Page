...
const CustomerToggleOptionsPage: React.FC = () => {
  ...
  const stakeholdersData: StakeholderData[] = [
    ...
    {
      title: "Customer's industry or sector:",
      value: "Tech",
    },
    {
  ...
  const stakeholdersAddress: StakeholderData[] = [
    ...
    {
      title: "Customer's Primary Communication Preference:",
      value: "Email",
    },
    {
      title: "Customer's Contact Person Name:",
      value: "Ibeneme Ikenna",
    },
    {
      title: "Customer's Contact Person Title:",
      value: "Mr",
    },
    {
      title: "Customer's Contact Person Email:",
      value: "Ibenemeikenna2021@gmail.com",
    },
    {
      title: "Customer's Contact Person Phone Number:",
    ...
    >
        ...
        <div>
          <div className="white-content-getstakeholders">
            <div className="white-content-getstakeholders-details">
              <span className="span-bg-faint">Customers Basic Details</span>{" "}
              <br />
              <br />
          ...
          <div className="white-content-getstakeholders">
            <div className="white-content-getstakeholders-details">
              <span className="span-bg-faint">
                {" "}
                Customers Address and Contact Details
              </span>{" "}
              <br />
              <br />
      ...
      {activeOption === "legalAndFinancial" && (
        <div>
          <div className="white-content-getstakeholders">
            <div className="white-content-getstakeholders-details">
              <span className="span-bg-faint">Customers Contract Details</span>{" "}
              <br />
              <br />
      ...
      {activeOption === "extras" && (
        <div>
          <div className="white-content-getstakeholders">
            <div className="white-content-getstakeholders-details">
              <span className="span-bg-faint">Customers Extra Details</span>{" "}
              <br />
              <br />
...
export default CustomerToggleOptionsPage;
