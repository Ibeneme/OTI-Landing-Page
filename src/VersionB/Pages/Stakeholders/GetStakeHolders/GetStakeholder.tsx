...
const ToggleOptionsPage: React.FC = () => {
  ...
  const stakeholdersData: StakeholderData[] = [
    {
      title: "Stakeholders Name:",
      value: "Ibeneme Ikenna",
    },
    {
      title: "Nature and details of relationship:",
      value: "Client",
    },
    {
      title: "Stakeholder's industry or sector:",
      value: "Sector",
    },
    {
      title: "Strategic Stakeholder Manager (SSM):",
      value: "Hephizbah Igbinosa",
    },
    {
      title: "Upload Due Diligence:",
      value: "Type 1",
    },
  ];
    ...
    >
        ...
        <div>
          <div className="white-content-getstakeholders">
            <div className="white-content-getstakeholders-details">
              <span className="span-bg-faint">Client Basic Details</span> <br />
              <br />
      ...
      {activeOption === "addressAndContact" && (
        <div>
          <div className="white-content-getstakeholders">
            <div className="white-content-getstakeholders-details">
              <span className="span-bg-faint">Address and Contact Details</span>{" "}
              <br />
              <br />
      ...
      {activeOption === "extras" && (
        <div>
          <div className="white-content-getstakeholders">
            <div className="white-content-getstakeholders-details">
              <span className="span-bg-faint">Client Extra Details</span> <br />
              <br />
...
export default ToggleOptionsPage;
