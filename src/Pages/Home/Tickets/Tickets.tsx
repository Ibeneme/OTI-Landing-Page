...
import useFetchAllTickets from "../Dashboard/Hook/useTickets";
...
const TicketDashboard: React.FC = () => {
  ...
  console.log(createTicketFormData.handler_id, "createTicketFormData");
  const resetFormData = () => {
                  ...
                  deptsSupport.map((user: UsersLogItem) => (
                    ...
                    >
                      ...
                      <FaCircleCheck
                        style={{
                          display:
                            selectedUserIds === user.id ? "block" : "none",
                        }}
                      />
                    </button>
                  ))}{" "}
              ...
              {shimmerLoader ? (
                ...
                <div>
                  {allTickets?.length === 0 ? (
                    ...
                    >
                      {userProfile.permission_type === "support" ? null : (
