...
const StakeholdersLogs: React.FC = () => {
                ...
                <div>
                  ...
                  <span
                    ...
                    <h2 className="main-content-dashboard-h2">
                      Data Logged for Stakeholder {stakeholders_name}
                    </h2>
                    <p className="main-content-dashboard-p">
                      Data Logged for Stakeholder{" "}{stakeholders_name} {stakeholders_email}
                    </p>
                  </div>{" "}
                </div>
              </div>
...
export default StakeholdersLogs;
