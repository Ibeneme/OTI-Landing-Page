...
const CreatePassword: React.FC = () => {
  ...
  const handleClick = () => {
    ...
    if (!passwordRegex.test(formData.createPassword)) {
      setErrors({
        createPassword:
          "Password must contain a minimum of 8, Alphanumeric a mix of uppercase, lowercase, numbers, and special characters",
      });
      return;
    }
    ...
    <div className="auth-container">
      <div className="auth-forms-div">
        <FormTop
          ...
          warningText="Password must contain a minimum of 8, Alphanumeric a mix of uppercase, lowercase, numbers, and special characters"
        />
